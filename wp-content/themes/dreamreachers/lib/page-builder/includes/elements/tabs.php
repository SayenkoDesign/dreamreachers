...
class Element_Tabs extends Element_Base {
	...
	public function render() {
        ...
        $panels = sprintf( '<div class="column row"><div class="panels"><div class="slick-wrap"><div class="slick">%s</div></div><div class="slick-arrows"></div></div></div>', $panels );
        
                
        $this->add_render_attribute( 'element', 'class', 'tabs' );
                                    
        return sprintf( '<div %s>%s</div>', $this->get_render_attribute_string( 'element' ), $panels );
	}
